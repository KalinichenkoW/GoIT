...
class ContactBook:
    ...
    def main(self):
        ...
        while True:
            ...
            choice = input(Fore.BLUE + 'Enter your choice (0/1/2/3/4/5): ' + Style.RESET_ALL)
...
def display_commands(text_command, pet="Exit"):

    lists_comands = dict(exit=Command_Exit_0(text_command), add=Command_Add(text_command))
    return pets.get(pet)    
